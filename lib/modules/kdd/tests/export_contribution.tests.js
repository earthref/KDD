...
import ExportContribution from '/lib/modules/kdd/export_contribution';
import {default as contribution_3 } from '/lib/modules/kdd/unit_tests/files/contributions/3.0';
//import {default as contribution3552 } from '/lib/modules/kdd/unit_tests/files/contributions/3552';
//import {default as contribution8054 } from '/lib/modules/kdd/unit_tests/files/contributions/8054';
//import {default as contribution10507} from '/lib/modules/kdd/unit_tests/files/contributions/10507_partial';

describe('kdd.actions.export_contribution', () => {
  ...
  describe('when exporting invalid JSON to text', () => {
    ...
    it('should reject if the column name is invalid.', () => {
      ...
      exportContributionToTextErrorTest(invalidColumn,
        /column .* in table .* is not defined in kdd data model/i);
    });
