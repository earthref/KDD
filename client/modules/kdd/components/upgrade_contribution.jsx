...
import UpgradeContribution from '/lib/modules/kdd/upgrade_contribution.js';
              ...
              {(this.state.isUpgraded && nUpgradeErrors === 0 ?
                <div>
                  ...
                  <div className="ui five stackable cards">
                    <IconButton
                      className="borderless card" portal="GERM" onClick={this.saveExcel.bind(this)}
                    >
                      <i className="icons">
                    ...
                    <IconButton
                      className="borderless card" portal="GERM" onClick={this.saveText.bind(this)}
                    >
                      <i className="icons">
                    ...
                    <IconButton
                      className="disabled borderless card" portal="GERM" onClick={this.saveText.bind(this)}
                    >
                      <i className="icons">
                        <i className="file text outline icon"/>
                    ...
                    <IconButton
                      className="borderless card" portal="GERM" onClick={this.upload.bind(this)}
                    >
                      <i className="icons">
                    ...
                    <IconButton
                      className="borderless card" portal="GERM" onClick={this.restart.bind(this)}
                    >
                      <i className="icons">
                        <i className="file text outline icon"/>
