  ...
  search(str) {
    ...
    if (str !== '') {
      ...
      $tbls.find('.data-model-table-count').each(function() {
        ...
        $(this).addClass(portals['GERM'].color);
      ...
      $(this.refs['count']).addClass(portals['GERM'].color);
    }
    ...
    // Enable all columns since the search string is empty.
      ...
      $counts.removeClass(portals['GERM'].color);
      $counts.children().remove();
      $(this.refs['count']).html($cols.length);
      $(this.refs['count']).removeClass(portals['GERM'].color);
    }
      ...
      <div className="data-model">
        <div className="ui top attached tabular menu">
          ...
          {versions.slice().reverse().map((v,i) => {
            ...
            return (
              <Link key={i} className={classes} to={`/KdD/data-models/${v}`}>
                {v}
                {(v === version ?
                  <div
                    ref="count"
            ...
            <div className="active item">
              <div className="ui search">
                <div className="ui transparent icon input">
                  ...
                  />
                  { this.state.search ?
                    <i className={portals['GERM'].color + ' close link icon'} onClick={this.clearSearch.bind(this)}/>:
                    <i className={portals['GERM'].color + ' search icon'}/>
                  }
                </div>
