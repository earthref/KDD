...
//import ExportContribution from '/client/modules/kdd/actions/export_contribution.js';
...
export default class UploadContribution extends React.Component {
  ...
  render() {
    ...
    if (this.state.uploaded) return <Redirect push to="/KdD/private"/>;
        ...
        <div className="ui top attached segment" ref={(el) => el && el.style.setProperty('width', 'calc(100% + 2px)', 'important')}>
          <div className="ui center aligned two column relaxed grid">
            <div className="column">
              <IconButton
                className="borderless card" portal="GERM"
          ...
          <div ref="accordion" className="ui accordion">
            ...
            <div ref="select step message" className="active content select-step-content">
              ...
              <div className="ui five stackable cards">
                <IconButton
                  className="borderless card" portal="GERM" position="bottom left"
                ...
                <IconButton
                  className="borderless card" portal="GERM" position="bottom center"
                  tooltip={'Click to upload this example dataset into your private ' +
                  'workspace. You can always delete it later.'}
                ...
                <IconButton
                  className="borderless card" portal="GERM" position="bottom right"
                  tooltip={'Click to upload this example dataset into your private ' +
                  'workspace. You can always delete it later.'}
